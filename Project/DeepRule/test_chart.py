...
def test(db, split, testiter, debug=False, suffix=None):
    with torch.no_grad():
        ...
        nnet.cuda()
        nnet.eval_mode()
        return testing(db, nnet, result_dir, debug=debug)
...
if __name__ == "__main__":
    ...
    """
    images_dir =  os.path.join(args.data_dir,'line/images/test2019')
    ...
    for image in tqdm(images):
        ...
        test_result = test(image,testing_db, args.split, args.testiter, args.debug, args.suffix)
