...
def kp_detection(image, db, nnet, debug=False, decode_func=kp_decode, cuda_id=0, nnet1=None, nnet2=None, nnet3=None, nnet4=None):
    K = db.configs["top_k"]
    ...
    if True:
        ...
        if nnet1 != None and nnet2 != None and nnet3 != None and nnet4 != None:
            ...
            dets_tl1, dets_br1, flag1 = decode_func(nnet1, images, K, ae_threshold=ae_threshold, kernel=nms_kernel)
            _rescale_points(dets_tl1, ratios, borders, sizes)
            _rescale_points(dets_br1, ratios, borders, sizes)
            
            dets_tl2, dets_br2, flag2 = decode_func(nnet2, images, K, ae_threshold=ae_threshold, kernel=nms_kernel)
            _rescale_points(dets_tl1, ratios, borders, sizes)
            _rescale_points(dets_br1, ratios, borders, sizes)
            
            dets_tl3, dets_br3, flag3 = decode_func(nnet3, images, K, ae_threshold=ae_threshold, kernel=nms_kernel)
            _rescale_points(dets_tl1, ratios, borders, sizes)
            _rescale_points(dets_br1, ratios, borders, sizes)
            
            dets_tl4, dets_br4, flag4 = decode_func(nnet4, images, K, ae_threshold=ae_threshold, kernel=nms_kernel)
            _rescale_points(dets_tl1, ratios, borders, sizes)
            _rescale_points(dets_br1, ratios, borders, sizes)
            ...
            detections_point_tl.append(dets_tl1)
            detections_point_br.append(dets_br1)
            
            detections_point_tl.append(dets_tl2)
            detections_point_br.append(dets_br2)
            
            detections_point_tl.append(dets_tl3)
            detections_point_br.append(dets_br3)
            
            detections_point_tl.append(dets_tl4)
            detections_point_br.append(dets_br4)
...
def testing(image, db, nnet, debug=False, nnet1=None, nnet2=None, nnet3=None, nnet4=None):
    return globals()[system_configs.sampling_function](image, db, nnet, debug=debug, nnet1=nnet1, nnet2=nnet2, nnet3=nnet3, nnet4=nnet4)
