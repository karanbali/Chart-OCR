...
class Bar(DETECTION):
    def __init__(self, db_config, split):
        ...
        print("data_dir: {} result_dir: {} cache_dir: {} split: {}  s_ds: {} s_lblf: {} s_imgdir: {} s_imgfile: {}  ".format(data_dir,result_dir,cache_dir,split,self._dataset,self._label_file,self._image_dir,self._image_file))
    ...
    def _extract_data(self):
        ...
        print("IMAGE_IDS",coco_image_ids)
        self._image_ids = [
            self._coco.loadImgs(img_id)[0]["file_name"]
            for img_id in coco_image_ids
        ]
