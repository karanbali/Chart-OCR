...
if __name__ == "__main__":
    ...
    tar_path = '/content/gdrive/MyDrive/Fall_21/Final_projects/linedata/line/images/test2019'
    save_path = '/content/gdrive/MyDrive/Fall_21/Final_projects/DeepRule/save/line.json'
    rs_dict = {}
